<?php $title = "Le chapitre 4" ?>
<?php include_once("header.php") ?>

<div class="main chapter four">
	...
	<div class="intro">
		...
		<div class="row">
			<div class="nine twelfths mobile centered">
				<h1>Chapitre <span class="gold">04</span></h1>
			</div>
		</div>
		<div class="row">
			<div class="seven twelfths tablet centered">
				<h2 class="letter-spacing">Green Village</h2>
			</div>
		</div>
		<div class="row">
			<div class="seven twelfths tablet centered">
				<p class="white">Ayant fui l’atmosphère hostile de votre dernière étape de voyage, vous atterrissez à Green Village. Ici, la végétation est accueillante, paisible. Elle n’a rien détruit, mais suit les formes des bâtiments. Profitez à nouveau du silence. De l’odeur de l’herbe. Ici, une beauté paisible et bienveillante est à l’oeuvre.
				</p>
			</div>
		</div>
	</div>
	<div class="text">
		<div class="row vwdesk">
			<div class="one half tablet">
				<img src="images/chap4/chap4_img1.jpg" alt="Green Village" class="chapterImage" />
			</div>
			<div class="one half tablet">
				<p class="valign">
		...
		<div class="row vwdesk">
			...
			<div class="one half tablet">
				<img src="images/chap4/chap4_img2.jpg" alt="Green Village" class="chapterImage" />
			</div>
		</div>
		<div class="row">
			<div class="one centered half tablet">
	...
	<div class="en-bref">
		...
		<div class="row">
			<div class="eight twelfths tablet centered">
				<p class="white">
					Green Village était autrefois un village de pêcheurs prospère. Aujourd’hui déserté pour cause d’exode rurale et de changements économiques, le village et ses maisons sont aujourd’hui recouverts par une végétation faite de lierre et de vigne.<br>
					Ce village se trouve sur l’île de Goqui, à l’embouchure du fleuve Yangtze.
				</p>
			</div>
		</div>
	</div>
	<div class="map-chapter">
		<img src="images/chap4/chap4_map.png" alt="" />
	</div>

	<div class="next-chapter valign-wrapper">
		<div class="valign" style="height: 80px;">
			<a href="chapter3.php" class="left valign-wrapper">
				<div class="line valign"></div>
				<div class="dot valign"></div>
				<p class="link valign uppercase">Chapitre<span class="gold">03</span></p>
			</a>
			<a href="chapter5.php" class="right valign-wrapper">
				<p class="link valign"><span class="uppercase">Chapitre</span><span class="gold">05</span><br>Ankor</p>
				<img class="dot valign"src="images/chap5/chap5_small.jpg" alt="Aller au chapitre 5"/>
				<div class="line valign"></div>
			</a>
		</div>
	</div>
