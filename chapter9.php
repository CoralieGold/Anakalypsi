...
<div class="main chapter nine">
	...
	<div class="intro">
		...
		<div class="row">
			<div class="seven twelfths tablet centered">
				<p class="white">
					Vous arrivez vers la fin de votre voyage. <br>Vous faites une dernière escale avant de chercher un moyen de rentrer.
				</p>
			</div>
		</div>
	</div>
		<div class="text">
			<div class="row vwdesk">
				<div class="one half tablet">
					<img src="images/chap9/chap9_img1.jpg" alt="Vue de l'interieur du casino" class="chapterImage" />
				</div>
				<div class="one half tablet">
					<p class="valign">
			...
			<div class="row vwdesk">
				...
				<div class="one half tablet">
					<img src="images/chap9/chap9_img2.jpg" alt="Vue de l'exterieur du casino" class="chapterImage" />
				</div>
			</div>
			<div class="row">
				<div class="one centered half tablet">
		...
		<div class="map-chapter">
			<img src="images/chap9/chap9_map.png" alt="" />
		</div>

		<div class="next-chapter valign-wrapper">
			<div class="valign" style="height: 80px;">
				<a href="chapter8.php" class="left valign-wrapper">
					<div class="line valign"></div>
					<div class="dot valign"></div>
					<p class="link valign uppercase">Chapitre<span class="gold">08</span></p>
				</a>
				<a href="chapter10.php" class="right valign-wrapper">
					<p class="link valign"><span class="uppercase">Chapitre</span><span class="gold">10</span><br>Orient Express</p>
					<img class="dot valign"src="images/chap10/chap10_small.jpg" alt="Aller au chapitre 10"/>
					<div class="line valign"></div>
				</a>
			</div>
		</div>
