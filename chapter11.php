...
<div class="main chapter eleven">
	<div class="gold-border center">
		...
		<div class="text">
			<div class="row valign-wrapper" style="margin-top:160px;">
				<div class="one half one-up-ipad">
					<img src="images/chap11/chap11_img1.jpg" alt="" class="chapterImage" />
				</div>
				<div class="one half one-up-ipad">
					<p class="valign">
			...
			<div class="row valign-wrapper">
				...
				<div class="one half one-up-ipad">
					<img src="images/chap11/chap11_img2.jpg" alt="" class="chapterImage" />
				</div>
			</div>
			<div class="row">
				<div class="one centered half one-up-ipad">
		...
		<div class="map-chapter">
			<img src="images/chap11/chap11_map.jpg" alt="" />
		</div>
			...
			<div class="row">
				<div class="one half">
					<a href="chapter10.php" class="valign-wrapper">
						...
						<p class="linkLeft valign white uppercase letter-spacing semibold">Chapitre<span class="gold">10</span></p>
					</a>
				</div>
<!--
				<div class="one half">
