<?php $title = "Le chapitre 6" ?>
<?php include_once("header.php") ?>

<div class="main chapter six">
	...
	<div class="intro">
		...
		<div class="row">
			<div class="seven twelfths tablet centered">
				<h2 class="letter-spacing">Floating Forest</h2>
			</div>
		</div>
		<div class="row">
			<div class="seven twelfths tablet centered">
				<p class="white">Vous atteignez la fin de la première partie du voyage. Profitez une dernière fois du silence, de la végétation et de l’immobilité du lieu où vous vous rendez. Fermez les yeux. Votre conscience est à nouveau seule, au centre de tout. Mais souhaitez-vous toujours être seul ? Ouvrez les yeux et découvrez non loin la possibilité d’un futur en communauté.
				</p>
			</div>
		</div>
	</div>
		<div class="text">
			<div class="row vwdesk">
				<div class="one half tablet">
					<img src="images/chap6/chap6_img1.jpg" alt="Vue de face du bateau forêt" class="chapterImage" />
				</div>
				<div class="one half tablet">
					<p class="valign">
			...
			<div class="row vwdesk">
				...
				<div class="one half tablet">
					<img src="images/chap6/chap6_img2.jpg" alt="Vue de haut du bateau" class="chapterImage" />
				</div>
			</div>
			<div class="row">
				<div class="one centered half tablet">
					...
					<p>
						Je continue jusqu’à atteindre une nouvelle terre.
					</p>
				</div>
			</div>
		</div>
		<div class="en-bref">
			...
			<div class="row">
				<div class="eight twelfths tablet centered">
					<p class="white">
						Le SS Ayrfield était un navire charbonnier durant la seconde guerre mondiale. Il est ramené à Sydney pour être démantelé mais le chantier naval ferme. Depuis la nature à repris ses droits et le bateau abrite maintenant des dizaines d’arbres de la mangrove, d'où son nom, la Forêt Flottante.<br>
						La Forêt Flottante se situe vers Sydney, au sud-est de l’Australie.
					</p>
				</div>
			</div>
		</div>
		<div class="map-chapter">
			<img src="images/chap6/chap6_map.png" alt="" />
		</div>
	
		<div class="next-chapter valign-wrapper">
			<div class="valign" style="height: 80px;">
				<a href="chapter5.php" class="left valign-wrapper">
					<div class="line valign"></div>
					<div class="dot valign"></div>
					<p class="link valign uppercase">Chapitre<span class="gold">05</span></p>
				</a>

				<a href="chapter7.php" class="right valign-wrapper">
					<p class="link valign"><span class="uppercase">Chapitre</span><span class="gold">07</span><br>Hôtel de Salto</p>
					<img class="dot valign"src="images/chap7/chap7_small.jpg" alt="Aller au chapitre 7"/>
					<div class="line valign"></div>
				</a>
			</div>
		</div>
