...
<div class="main chapter six">
	<div class="gold-border center">
		...
		<div class="text">
			<div class="row valign-wrapper" style="margin-top:160px;">
				<div class="one half one-up-ipad">
					<img src="images/chap6/chap6_img1.jpg" alt="" class="chapterImage" />
				</div>
				<div class="one half one-up-ipad">
					<p class="valign">
			...
			<div class="row valign-wrapper">
				...
				<div class="one half one-up-ipad">
					<img src="images/chap6/chap6_img2.jpg" alt="" class="chapterImage" />
				</div>
			</div>
			<div class="row">
				<div class="one centered half one-up-ipad">
		...
		<div class="map-chapter">
			<img src="images/chap6/chap6_map.jpg" alt="" />
		</div>
