<?php $title = "Le chapitre 10" ?>
<?php include_once("header.php") ?>

<div class="main chapter ten">
	<div class="gold-border center">
		...
		<div class="row">
			<div class="eleven twelfths skip-one">
				<h1>Chapitre <span class="gold">10</span></h1>
			</div>
		</div>
		<div class="row">
			<div class="eight twelfths skip-two">
				<h2 class="letter-spacing">Orient Express</h2>
			</div>
		</div>
		<div class="row">
			<div class="eight twelfths skip-two">
				<p class="white">
					Vous avez enfin trouvé votre moyen de rentrer chez vous. Profitez une dernière fois de l’immobilité, du silence. Partez serein, prêt à retourner à la civilisation.
				</p>
			</div>
		</div>
		<div class="text">
			<div class="row valign-wrapper" style="margin-top:160px;">
				<div class="one half one-up-ipad">
					<img src="images/chap10/chap10_img1.jpg" alt="" class="chapterImage" />
				</div>
				<div class="one half one-up-ipad">
					<p class="valign">
			...
			<div class="row valign-wrapper">
				...
				<div class="one half one-up-ipad">
					<img src="images/chap10/chap10_img2.jpg" alt="" class="chapterImage" />
				</div>
			</div>
			<div class="row">
				<div class="one centered half one-up-ipad">
		...
		<div class="en-bref">
			...
			<div class="row">
				<div class="eight twelfths skip-two">
					<p class="white">
						Situé sur une voie de chemin de fer encore active, l’Orient Express est issu d’un ensemble de trois fabrications identiques fonctionnant au diesel-électrique, lancées dans les années 30. Il est le dernier encore visitable et n’est plus en fonctionnement de 1977.<br>
						Ce vestige de train est situé au nord de la Belgique.
					</p>
				</div>
			</div>
		</div>
		<div class="map-chapter">
			<img src="images/chap10/chap10_map.jpg" alt="" />
		</div>
			...
			<div class="row">
				<div class="one half">
					<a href="chapter9.php" class="valign-wrapper">
						...
						<p class="linkLeft valign white uppercase letter-spacing semibold">Chapitre<span class="gold">09</span></p>
					</a>
				</div>

				<!-- <div class="one half">
					<a href="chapter11.php" class="valign-wrapper">
						<p class="linkRight valign white letter-spacing semibold"><span class="uppercase">Chapitre</span><span class="gold">11</span><br>Orient Express</p>
						<img class="dotRight valign"src="images/chap11/chap11_small.jpg" alt="Aller au chapitre 11"/>
