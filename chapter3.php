<?php $title = "Le chapitre 3" ?>
<?php include_once("header.php") ?>

<div class="main chapter three">
	<div class="gold-border center"></div>
		...
		<div class="row">
			<div class="nine twelfths mobile centered">
				<h1>Chapitre <span class="gold">03</span></h1>
			</div>
		</div>
		<div class="row">
		...
		<div class="text">
			<div class="row vwdesk">
				<div class="one half tablet">
					<img src="images/chap3/chap3_img1.jpg" alt="Chambre d'un immeuble près de Tchernobyl" class="chapterImage" />
				</div>
				<div class="one half tablet">
					<p class="valign">
		...
		<div class="map-chapter">
			<img src="images/chap3/chap3_map.png" alt="" />
		</div>

		<div class="next-chapter valign-wrapper">
			<div class="valign" style="height: 80px;">
				<a href="chapter2.php" class="left valign-wrapper">
					<div class="line valign"></div>
					<div class="dot valign"></div>
					<p class="link valign uppercase">Chapitre<span class="gold">02</span></p>
				</a>
				<a href="chapter4.php" class="right valign-wrapper">
					<p class="link valign"><span class="uppercase">Chapitre</span><span class="gold">04</span><br>Green Village</p>
					<img class="dot valign"src="images/chap4/chap4_small.jpg" alt="Aller au chapitre 4"/>
					<div class="line valign"></div>
				</a>
			</div>
		</div>
