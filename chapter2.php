		...
		<div class="text">
			<div class="row valign-wrapper" style="margin-top:160px;">
				<div class="one half one-up-ipad">
					<img src="images/chap2/chap2_img1.jpg" alt="" class="chapterImage" />
				</div>
				<div class="one half one-up-ipad">
					<p class="valign">
			...
			<div class="row valign-wrapper">
				...
				<div class="one half one-up-ipad">
					<img src="images/chap2/chap2_img2.jpg" alt="" class="chapterImage" />
				</div>
			</div>
			<div class="row">
				<div class="one centered half one-up-ipad">
			...
			<div class="row">
				<div class="one half">
					<a href="chapter1.php" class="valign-wrapper">
						...
						<p class="linkLeft valign white uppercase letter-spacing semibold">Chapitre <span class="gold">01</span></p>
					</a>
				</div>

				<div class="one half">
					<a href="chapter3.php" class="valign-wrapper">
						<p class="linkRight valign white letter-spacing semibold"><span class="uppercase">Chapitre</span><span class="gold">03</span><br>Tchernobyl</p>
