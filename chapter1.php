...
<div class="main chapter one">
	...
	<div class="text">
		<div class="row vwdesk">
			<div class="one half tablet">
				<img src="images/chap1/chap1_img1.jpg" alt="Exterieur de l'Église Saint Sulpice" class="chapterImage" />
			</div>
			<div class="one half tablet">
				<p class="valign">
		...
		<div class="row vwdesk">
			...
			<div class="one half tablet">
				<img src="images/chap1/chap1_img2.jpg" alt="Intérieur de l'Église Saint Sulpice" class="chapterImage" />
			</div>
		</div>
		<div class="row">
			<div class="one centered half tablet">
	...
	<div class="map-chapter">
		<img src="images/chap1/chap1_map.png"/>
	</div>
